...
(function lunarBoot() {
  ...
  function playIntro() {
    ...
    try {
      Y.setState({ started: false, found: [], notes: [], cineFresh: false, seenIntro: false });
    } catch {}
    try {
      const g = Y.getState();
      if (typeof g.startCine === "function") g.startCine(false);
    } catch {}
    try {
      Y.setState({
        screen: "intro",
  ...
  function startPlay(fresh) {
    ...
    try {
      if (typeof g.startGame === "function") g.startGame(false);
    } catch {}
    try {
      Y.setState({
        started: true,
